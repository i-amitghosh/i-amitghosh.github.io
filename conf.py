...
BLOG_AUTHOR = "Amit Ghosh"  # (translatable)
BLOG_TITLE = "Amit's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://i-amitghosh.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://i-amitghosh.github.io/"
BLOG_EMAIL = "ghoshamitag@live.in"
BLOG_DESCRIPTION = "Spatial"  # (translatable)
